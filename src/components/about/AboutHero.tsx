...
const AboutHero = () => {
  ...
  return (
    <section className="relative pt-32 pb-20 overflow-hidden min-h-[90vh] flex items-center">
      ...
      {/* Ambient blob - single orb kept for about hero */}
      <div className="absolute bottom-10 right-10 w-80 h-80 bg-aurora-blue/10 rounded-full blur-3xl pointer-events-none animate-pulse-soft" />
