...
const WhoWeAre = () => {
  ...
  return (
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="absolute top-20 right-10 w-72 h-72 bg-aurora-purple/10 rounded-full blur-3xl pointer-events-none animate-pulse-soft" />
      <div className="absolute bottom-10 left-10 w-80 h-80 bg-aurora-blue/8 rounded-full blur-3xl pointer-events-none animate-pulse-soft" style={{ animationDelay: "1.5s" }} />
        ...
        >
          ...
          <div className="grid grid-cols-1 gap-4">
            {[
              ...
              <div
                key={item.title}
                className={`group glass-card rounded-2xl p-6 hover:shadow-2xl hover:border-white/20 transition-all duration-300 opacity-0 ${isVisible ? "animate-scale-in" : ""}`}
