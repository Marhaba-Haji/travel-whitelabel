...
import {
  ...
  DollarSign, Ticket, Settings, LogOut, Menu, X, FileText, Globe, UserCog, Network, Type, Image, Star, CircleHelp, CalendarCheck, GraduationCap, Code2, Plane
} from "lucide-react";
...
const allTabs = [
  ...
  { id: "umrah", label: "Umrah Leads", icon: Plane },
